...
public class Dungeon {
	...
	//Add isTutorial check that results in using strings from tutorial tips array
	...
	//Will need to be modifed for map editor (should read shop floors from bundle)
	...
	//Should be read from bundle with custom maps
